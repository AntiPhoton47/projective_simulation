...
# %% ../../nbs/lib_nbs/envs/foraging_envs.ipynb #cc944947-aef5-4f8f-bc02-54b4abda36dc
import numpy as np
import math
import random

# %% ../../nbs/lib_nbs/envs/foraging_envs.ipynb #ac0c5bd6-0220-4ed5-99a7-8be2b9775713
...
# %% ../../nbs/lib_nbs/envs/foraging_envs.ipynb #36567cb6-7e16-4860-bd57-c43be26fa8ed
@maybe_njit()
...
# %% ../../nbs/lib_nbs/envs/foraging_envs.ipynb #1023cf70-3639-4629-9ab1-76eb94bd20ad
@maybe_njit()
...
# %% ../../nbs/lib_nbs/envs/foraging_envs.ipynb #88a5fee3-fac9-42fe-88a1-b12b0f4493be
@maybe_njit()
...
# %% ../../nbs/lib_nbs/envs/foraging_envs.ipynb #1d3f8518-7596-4126-ae87-9d48e4dbfbab
if NUMBA_ACTIVATED:
...
# %% ../../nbs/lib_nbs/envs/foraging_envs.ipynb #657f70be-ac30-4f9c-8c12-b0938eb60270
@maybe_jitclass()
class ResetEnv_1D():
    L : float
    D : float    
...
# %% ../../nbs/lib_nbs/envs/foraging_envs.ipynb #b1ba1108
@maybe_njit()
...
# %% ../../nbs/lib_nbs/envs/foraging_envs.ipynb #8900112c
...
# %% ../../nbs/lib_nbs/envs/foraging_envs.ipynb #4a9ee9ec-6a02-452f-8017-778c9b81cf5a
if NUMBA_ACTIVATED:
...
# %% ../../nbs/lib_nbs/envs/foraging_envs.ipynb #865d458f-a0eb-4683-8fc1-82d9a3b47569
@maybe_njit(parallel = True)
...
# %% ../../nbs/lib_nbs/envs/foraging_envs.ipynb #747fb886-db05-40b9-b569-b6b8a361ae60
if NUMBA_ACTIVATED:
    spec = [("position", float64[:]),
               ("target_position", float64[:,:]),
               ("previous_pos", float64[:])
...
# %% ../../nbs/lib_nbs/envs/foraging_envs.ipynb #1306cd1d
