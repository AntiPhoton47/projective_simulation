...
# %% ../../nbs/lib_nbs/methods/00_preprocessors.ipynb #8fc75263-8588-4218-af45-f43d33fe9d6c
def get_percept(observation):
    percept = str(observation)
    return(percept)

# %% ../../nbs/lib_nbs/methods/00_preprocessors.ipynb #c6a43bbf-bebf-422e-9a0e-a74632fc8b76
import numpy as np
...
# %% ../../nbs/lib_nbs/methods/00_preprocessors.ipynb #ee2727ce-8945-45af-aa67-a5f2a9e4b913
